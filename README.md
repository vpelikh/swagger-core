...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.50 (**current stable**)| 2026-05-12   | 3.x           | [tag v2.2.50](https://github.com/swagger-api/swagger-core/tree/v2.2.50) | Supported
...
### To build from source (currently 2.2.51-SNAPSHOT)
```
